   ...
   <div class="signin"> 
    ...
    <div class="content"> 
        ...
        <form action="" method="post">
            ...
            <div class="inputBox"> 
            <input value="<?php if(isset($emailValue)) echo $emailValue ?>" name="emaill" type="text"> <i>E-mail</i>            
            </div> 

            <small style="color:red"><?php echo $emailErrorMsg?></small>

            <div class="inputBox">
            <input id="passw" name="passv" type="password"> <i>Password</i> 
            </div> 
            ...
            <div class="inputBox"> 
                <!-- <div style="color:red"><?php echo $emailErrorMsg;?></div><br> -->
